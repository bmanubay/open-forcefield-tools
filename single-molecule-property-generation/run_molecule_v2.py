...
for ind,j in enumerate(mol_filename):
    ...
    paramlist2 = np.arange(float(sys.argv[5]),float(sys.argv[6]),float(sys.argv[7]))
    
    smirkseries = sys.argv[8]#'[#6X4:1]-[#1:2]'
    
    paramtype1 = sys.argv[9]#'length'
    paramtype2 = sys.argv[10]
