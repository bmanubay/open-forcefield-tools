...
torsion_r48_b = torstimeser_r48[14]
...
plt.figure()
(n1,bins1,patch1) = plt.hist(torsion_r48_a,num_bins,label='AlkEthOH_c1143 histogram',color='green')
#for i,j in enumerate(n1):
#	if j==0.:
#           n1[i]=5.

popt, pcov = sci.curve_fit(fourier, bins1[1:], n1, [100.0,3.0,1.0]*3 , maxfev=100000)
plt.plot(bins1[1:],fourier(bins1[1:],*popt),label='AlkEthOH_c1143 fourier fit')
plt.ylabel('Number of times configuration is sampled')
plt.xlabel('Torsion angle (radians)')
